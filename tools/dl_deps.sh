...
rm -rf "$BIN_DIR/metrowrap-v0.1.3-custom.8b95934-linux-x86_64.zip" "$BIN_DIR/metrowrap"
wget -O "$BIN_DIR/metrowrap-v0.1.3-custom.8b95934-linux-x86_64.zip" https://github.com/ThirstyWraith/metrowrap/releases/download/v0.1.3-custom.8b95934/metrowrap-v0.1.3-custom.8b95934-linux-x86_64.zip
sha256sum -c "$BIN_DIR/metrowrap-v0.1.3-custom.8b95934-linux-x86_64.zip.sha256"
unzip -d "$BIN_DIR/metrowrap" "$BIN_DIR/metrowrap-v0.1.3-custom.8b95934-linux-x86_64.zip"
rm -rf "$BIN_DIR/metrowrap-v0.1.3-custom.8b95934-linux-x86_64.zip"
...
rm -rf "$BIN_DIR/objdiff-linux-x86_64"
wget -O "$BIN_DIR/objdiff-linux-x86_64" https://github.com/encounter/objdiff/releases/download/v3.7.1/objdiff-linux-x86_64
sha256sum -c "$BIN_DIR/objdiff-linux-x86_64.sha256"
chmod a+x "$BIN_DIR/objdiff-linux-x86_64"
