...
rm -rf "$BIN_DIR/metrowrap-v0.1.3-custom.c0052d4-linux-x86_64.zip" "$BIN_DIR/metrowrap"
wget -O "$BIN_DIR/metrowrap-v0.1.3-custom.c0052d4-linux-x86_64.zip" https://github.com/ThirstyWraith/metrowrap/releases/download/v0.1.3-custom.c0052d4/metrowrap-v0.1.3-custom.c0052d4-linux-x86_64.zip
sha256sum -c "$BIN_DIR/metrowrap-v0.1.3-custom.c0052d4-linux-x86_64.zip.sha256"
unzip -d "$BIN_DIR/metrowrap" "$BIN_DIR/metrowrap-v0.1.3-custom.c0052d4-linux-x86_64.zip"
rm -rf "$BIN_DIR/metrowrap-v0.1.3-custom.c0052d4-linux-x86_64.zip"
